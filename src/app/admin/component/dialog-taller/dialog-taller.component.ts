...
import { TallerDialogMapaComponent } from './dialog-mapa/dialog-mapa.component';
...
export class DialogTallerComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialogTallerComponent>,
  ...
  openDialogAsignarUbicacion(_id?: string) {
    ...
    const dialogRef = this.dialog.open(TallerDialogMapaComponent, {
      height: '1000px',
      width: '1000px',
      data: {
        _id: _id,
