...
import { SitiosService } from 'src/app/admin/services/sitios.service';
...
export class DialogHorariosComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialogHorariosComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private sitiosServices: SitiosService) {
    if (this.data !== null) {
