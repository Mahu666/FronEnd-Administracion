...
export class EventDialogMapaComponent implements AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<EventDialogMapaComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
