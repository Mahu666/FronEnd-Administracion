...
import { ATDialogEventoComponent } from 'src/app/talent/component/dialog-evento/dialog-evento.component';
...
export class EventosComponent implements OnInit {
  ...
  openDialog(nombreEvento: string, imgPrincipal: string, descripcion: string, horario: string, ubicacion: string,
    ...
    if (_id != null) {
      ...
      const dialogRef = this.dialog.open(ATDialogEventoComponent, {
        height: '620px',
        width: '950px',
        data: {
