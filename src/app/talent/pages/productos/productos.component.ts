...
import { ATDialogProductoComponent } from 'src/app/talent/component/dialog-producto/dialog-producto.component';
...
export class ProductosComponent implements OnInit {
  ...
  openDialog(nombreProducto: string, imgPrincipal: string, descripcion: string, precioActual: string, precioAnterior: string,
    ...
    if (_id != null) {
      ...
      const dialogRef = this.dialog.open(ATDialogProductoComponent, {
        height: '600px',
        width: '950px',
        data: {
