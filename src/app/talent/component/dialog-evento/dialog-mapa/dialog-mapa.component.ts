...
import { EventosService } from 'src/app/talent/services/eventos.service';
...
export class TEventoDialogMapaComponent implements AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<TEventoDialogMapaComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
