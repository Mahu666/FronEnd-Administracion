...
export class TDialogMapaComponent implements AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<TDialogMapaComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
