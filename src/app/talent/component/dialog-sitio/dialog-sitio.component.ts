...
import { ATPServiciosComponent } from './servicios/servicios.component';
import { TDialogMapaComponent } from './dialog-mapa/dialog-mapa.component';
import { TDialogHorariosComponent } from './dialog-horarios/dialog-horarios.component';
...
export class ATDialogSitioComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ATPServiciosComponent>,
  ...
  openDialogAsignarServicios(_id?: string) {
    ...
    const dialogRef = this.dialog.open(ATPServiciosComponent, {
      height: '350px',
      width: '800px',
      data: {
        _id: _id,
  ...
  openDialogAsignarUbicacion(_id?: string) {
    ...
    const dialogRef = this.dialog.open(TDialogMapaComponent, {
      height: '1000px',
      width: '1000px',
      data: {
        _id: _id,
  ...
  openDialogAsignarHorario(_id?: string) {
    ...
    const dialogRef = this.dialog.open(TDialogHorariosComponent, {
      height: '700px',
      width: '1300px',
      data: {
        _id: _id,
  ...
  save() {
    ...
    this.sitiosServices.actualizarSitio(this.nombreSit, this.sitImg, this.vid, this.desc, this.bann, this.nombreCont1, this.telCont1, this.correoCont1,
      this.nombreCont2, this.telCont2, this.correoCont2, this.serv, this.horOpen, this.horClose, this.ubi, this.lice, this.fb, this.ins, this.sWeb, this.selectedCat,
      this.sitioId, this.selectedMun, this.selectedSTA, this.sitioId).subscribe(resp => {
        this.dialogRef.close("Se ha actualizado correctamente");
        window.location.reload();
      });
