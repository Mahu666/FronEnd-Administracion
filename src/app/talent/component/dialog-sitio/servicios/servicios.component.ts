...
export class ATPServiciosComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ATPServiciosComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
