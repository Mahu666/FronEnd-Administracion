...
import { TalleresService } from 'src/app/talent/services/talleres.service';
...
export class TTallerDialogMapaComponent implements AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<TTallerDialogMapaComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
