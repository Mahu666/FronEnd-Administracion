...
import { ADialogSitioComponent } from 'src/app/apapachador/component/dialog-sitio/dialog-sitio.component';
...
export class SitiosComponent implements AfterViewInit {
  ...
  openDialog(nombreSitio: string, imgPrincipal: string, video: string, descripcion: string, banner: string, nombreContacto1: string, telContacto1: string,
    ...
    if (_id != null) {
      ...
      const dialogRef = this.dialog.open(ADialogSitioComponent, {
        height: '740px',
        width: '1400px',
        data: {
  ...
  displayedColumns: string[] = ['nombreSitio', 'ubicacion', 'licencia', 'facebook', 'instagram', 'sitioWeb', 'status', 'acciones'];
  ...
  columnas = [
    ...
    { titulo: "Facebook", name: "facebook" },
    { titulo: "Instagram", name: "instagram" },
    { titulo: "SitioWeb", name: "sitioWeb" },
