...
import { ADialogTallerComponent } from 'src/app/apapachador/component/dialog-taller/dialog-taller.component';
...
export class TalleresComponent implements OnInit {
  ...
  openDialog(nombreTaller: string, imgPrincipal: string, descripcion: string, precio: string, ubicacion: string,
    ...
    if (_id != null) {
      ...
      const dialogRef = this.dialog.open(ADialogTallerComponent, {
        height: '620px',
        width: '950px',
        data: {
