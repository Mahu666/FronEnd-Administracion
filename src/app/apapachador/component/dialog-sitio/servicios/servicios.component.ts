...
export class APServiciosComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<APServiciosComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
