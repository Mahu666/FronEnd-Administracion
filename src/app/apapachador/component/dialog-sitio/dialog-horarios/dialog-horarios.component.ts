...
export class ADialogHorariosComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ADialogHorariosComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private sitiosServices: SitiosService) {
    if (this.data !== null) {
