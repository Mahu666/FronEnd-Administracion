...
import { TalleresService } from 'src/app/apapachador/services/talleres.service';
...
export class ATallerDialogMapaComponent implements AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<ATallerDialogMapaComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private authService: AuthService,
