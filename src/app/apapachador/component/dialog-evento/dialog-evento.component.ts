...
export class ADialogEventoComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ADialogEventoComponent>,
  ...
  openDialogAsignarUbicacion(_id?: string) {
    ...
    const dialogRef = this.dialog.open(AEventoDialogMapaComponent, {
      height: '1000px',
      width: '1000px',
      data: {
        _id: _id,
